...
paras = dict(p=np.array(101000, dtype=np.float64),  # Pressure, Pa
             ...
             #Qx=20,  # Qx for it product calcuated
             ...
             Totalflow=np.array(10.6, dtype=np.float64),  # total flow for the whole tube, lpm
             ...
             plot_spec=['OH', 'HSO3', 'HO2', 'SO3', 'H2SO4', 'SO2', 'H2O'],  # species that you want to plot
             file_name='H2O_5.csv',
...
if paras['model_mode'] == 'kinetic':  # This mode runs the code in kinetic mode in which chemistry does not exist
    ...
    paras['Init_comp'] = ['OH', 'HO2',
                          'H2SO4']  # here you may want to change the initial compounds that you already set in paras
