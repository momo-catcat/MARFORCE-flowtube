...
<<<<<<< HEAD
# created at 2022-01-12 17:29:47.025841
=======
# created at 2022-01-12 17:44:07.591667
...
def evaluate_rates(RO2, H2O, TEMP, lightm, M, N2, O2, NO, HO2, NO3,p):
	...
	rate_values[3] = 6.2e-14 * (TEMP / 298)**2.6 * numpy.exp(945/TEMP)
	rate_values[4] = 1.3e-12*numpy.exp(-330/TEMP)
	rate_values[5] = 3.9e-41 * numpy.exp(6830.6 / TEMP)
