...
def model_5(R2, R1, Rgrid, Zgrid, comp_num, L2, L1, numLoop, comp_namelist, key_spe_for_plot, dt, timesteps, Diff_vals,
            Rtot, \
            Q1, Q2, dydt_vst, rindx, nreac, rstoi, rate_values, const_comp, u, plot_spec, formula, c, dr, dx,sp_line):
    # %% first tube run
    #dx = L1 / (Zgrid - 1)
    ...
    for j in range(numLoop):
        ...
        c = odesolve_test(timesteps, Zgrid, Rgrid, dt, Diff_vals, Rtot, dr, dx, Q1, c, comp_namelist, dydt_vst,
                     rindx,
                     nreac, rstoi, rate_values, const_comp, u,sp_line, R1)
